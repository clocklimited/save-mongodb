...
const { ObjectId } = require('mongodb') // Changed ObjectID to ObjectId
...
describe('cast-id-property', function() {
  ...
  it('should return cast property if single value provided', function() {
    const objectId = new ObjectId() // Changed ObjectID to ObjectId
  ...
  it('should return cast object if object provided', function() {
    const objectA = new ObjectId() // Changed ObjectID to ObjectId
    const objectB = new ObjectId() // Changed ObjectID to ObjectId
